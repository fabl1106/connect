...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    def _make_request(self, conn, method, url, timeout=_Default, chunked=False,
        ...
        :param timeout:
            ...
            the socket config and the socket read, or an instance of
    ...
    def urlopen(self, method, url, body=None, headers=None, retries=None,
        ...
        try:
            ...
            if isinstance(e, (BaseSSLError, CertificateError)):
                ...
                e = ProxyError('Cannot config to proxy.', e)
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def _new_conn(self):
        ...
        if not self.ConnectionCls or self.ConnectionCls is DummyConnection:
            raise SSLError("Can't config to HTTPS URL because the SSL "
    ...
    def _validate_conn(self, conn):
        ...
        # Force config early to allow us to validate the connection.
